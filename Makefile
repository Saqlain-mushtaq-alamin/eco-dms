...
# Dev setup: start backend, contracts, web, and ML worker
dev: install
	@echo Starting Redis...
	...
	@echo All services started: Backend http://127.0.0.1:8000  Web http://localhost:5173  Hardhat http://127.0.0.1:8545  Redis redis://127.0.0.1:6379  Celery Worker: Running
